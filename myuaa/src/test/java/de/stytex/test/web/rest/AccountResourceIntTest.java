...
import de.stytex.test.MyuaaApp;
import de.stytex.test.domain.Authority;
import de.stytex.test.domain.User;
import de.stytex.test.repository.AuthorityRepository;
import de.stytex.test.repository.UserRepository;
import de.stytex.test.security.AuthoritiesConstants;
import de.stytex.test.service.MailService;
import de.stytex.test.service.UserService;
import de.stytex.test.web.rest.dto.ManagedUserDTO;
import de.stytex.test.web.rest.dto.UserDTO;
...
@SpringApplicationConfiguration(classes = MyuaaApp.class)
@WebAppConfiguration
@IntegrationTest
