...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "myuaagateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "myuaagateway API";

        private String description = "myuaagateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "myuaagateway";
